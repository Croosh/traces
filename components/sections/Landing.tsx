  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br  from-[#7c3aed]/20 to-yellow-100">
      ...
      <div className="flex w-full select-none">
        <div className="flex bg-primary/55 w-1/3 h-72 flex-col p-8  gap-2 relative group hover:bg-primary/30 transition-all">
          <span className=" font-bold text-4xl  group-hover:text-primary transition-all">
            Minimal
          </span>
          <p className=" text-lg  group-hover:text-primary transition-all">
            Clean and easy to use UI
          </p>
          <Sparkles
            className=" absolute bottom-12 right-12 group-hover:stroke-primary transition-all"
            strokeWidth={"1px"}
            width={96}
            height={96}
          />
        </div>
        <div className="flex bg-primary/35 w-1/3 h-72 flex-col p-8  gap-2 relative group hover:bg-primary/20 transition-all">
          <span className=" font-bold text-4xl group-hover:text-primary transition-all">
            3-in-1
          </span>
          <p className=" text-lg group-hover:text-primary transition-all">
        ...
        <div className="flex bg-primary/45 w-1/3 h-72 flex-col p-8  gap-2 relative group hover:bg-primary/25 transition-all">
          <span className=" font-bold text-4xl group-hover:text-primary transition-all">
            Secure
          </span>
          <p className=" text-lg group-hover:text-primary transition-all">
